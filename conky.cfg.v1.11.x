...
--=======================================================================
	...
	gap_x = 30,
	gap_y = 45,
	minimum_width = 240, minimum_height = 800,
	maximum_width = 220,
--## Conky Output
...
${voffset 8} ${font Weather:size=17}${color FFFFFF}yz${color}${font}   ${voffset -4}Temperature: ${color CCCCCC}${hddtemp /dev/sdb}°C${color}${alignr}/dev/sdb
